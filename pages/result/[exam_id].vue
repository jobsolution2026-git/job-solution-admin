...
const pageInfo = ref<PageInfo>({
  title: 'Result',
  description: 'Manage all your results here',
  apiUrl: '/admin/mcq-result',
});
...
const init = async (page: number = 1) => {
  ...
  let url = `${pageInfo.value.apiUrl}?exam_id=${route.params.exam_id}&page=${page}&per_page=${itemsPerPage.value}`;
