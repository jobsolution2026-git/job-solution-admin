...
const pageInfo = ref<PageInfo>({
  title: 'University',
  description: 'Manage all your university here',
  apiUrl: '/admin/universities',
});
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tr v-if="loader.isLoading && items &&  items.length"
                ...
                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                  <common-active-toggle :active="item.active" :url="`${pageInfo.apiUrl}/${item.id}/toggle`"
          ...
          <form @submit.prevent="onSubmit">
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <treeselect
                    :multiple="true"
                    :options="universityCategory.allItems"
                    :flat="true"
