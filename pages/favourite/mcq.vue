...
const pageInfo = ref<PageInfo>({
  title: 'Favourite MCQ',
  description: 'Show all favourite MCQ',
  apiUrl: '/admin/mcq-user',
});
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tr v-if="!loader.isLoading &&  items"
                ...
                <td class="px-4 py-2 mr-2">
                  <client-only>
                    <div v-katex="item?.mcq?.question" class="font-bold text-black latex"></div>
                  </client-only>
                </td>
                <td class="px-4 py-2 mr-2">
                ...
                <td class="px-4 py-2 mr-2">
                  <FavouriteMcqViewModal :item="item"/>
                </td>
              </tr>
              <tr v-else>
