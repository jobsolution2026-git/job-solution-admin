...
const pageInfo = ref<PageInfo>({
  ...
  description: 'Manage all your university FAQS',
  apiUrl: '/admin/faqs',
});
...
const init = async () => {
  ...
  const {data, pending, error, refresh} = await getData(`${pageInfo.value.apiUrl}?faqable_id=${route.query.faqable_id}&faqable_type=${route.query.faqable_type}`);
...
const onSubmit = handleSubmit(async values => {
  ...
  values.faqable_id = route.query.faqable_id
  values.faqable_type = route.query.faqable_type
