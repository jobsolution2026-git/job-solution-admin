          ...
          <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tr v-if="!loader.isLoading &&  items"
                ...
                <td class="px-4 py-2 mr-2">
                  <p class="font-medium text-black dark:text-white">{{ item?.user?.institution }}</p>
                </td>
                <td class="px-4 py-2 mr-2">
                  <p class="font-medium text-black dark:text-white">{{ item?.problem }}</p>
                </td>
                <td class="px-4 py-2 mr-2">
                  <p class="font-medium text-black dark:text-white">{{ item?.description }}</p>
                </td>
                <td class="px-4 py-2 mr-2">
                  <p class="font-medium text-black dark:text-white">{{ item?.flag_type }}</p>
                </td>
                <td class="px-4 py-2 mr-2">
