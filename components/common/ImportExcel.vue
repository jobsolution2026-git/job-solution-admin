...
const props = defineProps<{
  url: string;
  mcqStoreId?:  string | number | undefined
}>();
...
const onSubmit = async  () => {
  ...
  if (props.mcqStoreId) {
    formData.append('mcq_store_id', props.mcqStoreId.toString())
  }
...
<template>
  <div>
    <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="px-3 py-2 text-xs font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
      Import
    </button>
      ...
      <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <form @submit.prevent="onSubmit" class="p-4 md:p-5">
            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Import Excel</h3>
            <div class="mb-4">
              <form-input-label for="file" label="File" />
              <input
                  ref="inputRef"
                  type="file"
                  accept=".xlsx"
